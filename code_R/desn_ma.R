...
library(agricolae)
e <- new.env(parent=as.environment("package:agricolae"))
# simple alternative if you want access to everything
# e <- new.env(parent=globalenv())
# Make all functions in "myfile.R" have e as environment
source("~/code/code_R/desn.ma.R", local=e)
attach(e,name="myenv")
rm(list=ls())
ls()
detach("MADIIdgn")

design.maII(num.entries=330, num.rows=9, num.cols=NULL, num.sec.chk=3, designID="tester1", annoy=T)
