...
perl ~/code/code_perl/LoadScriptForTonyMetadata.pl -H localhost -D zea -i "$f11".csvmetadata


perl ~/code/loading_script/load_accessions_in_database_aimin.pl -H localhost -D zea -i 6x1008_WET10B-EVALTC-08-1_accession_tester11.csv -e "$2" -c "$3"

perl ~/code/code_perl/load_pedigrees_in_database_aimin.pl -H localhost -D zea -i 6x1008_WET10B-EVALTC-08-1_accession_pedigree.csv -e "$2" -c "$3"
...
cp "$f11"_rep1_accession.csv "$f11".csv
