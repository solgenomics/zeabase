...
perl $HOME/Code_BTI/code_perl/load_zeabase_snps.pl -H db3.sgn.cornell.edu -D zea -i <(cut -f2,66 WEMA_GBS_1008-2_hmp_maker_conversion_7.txt) -p GBS_Cornell_Biotech -g WEMA_6x1008 < $HOME/zeabase_access.txt
