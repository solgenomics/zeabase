...
perl ~/Code_BTI/code_perl/LoadScriptForTonyMetadata.pl -H db3.sgn.cornell.edu -D zea -i "$1"

perl ~/Code_BTI/loading_script/load_accessions_in_database_aimin.pl -H db3.sgn.cornell.edu -D zea -i "$4" -e "$2" -c "$3"

#perl ~/code/code_perl/load_pedigrees_in_database_aimin.pl -H localhost -D zea -i "$5" -e "$2" -c "$3"

perl ~/Code_BTI/code_perl/load_pedigrees_in_database_4_SYN.pl -H db3.sgn.cornell.edu -D zea -i "$5" -e "$2" -c "$3"
...
perl ~/Code_BTI/code_perl/LoadScriptForTonydata.pl -H db3.sgn.cornell.edu -D zea -i "$f11".csv
