...
=head1 COMMAND-LINE OPTIONS
 ...
 -y project year [2012]
 -g population name (e.g., NaCRRI training population)
...
my $coderef = sub {
	...
	###############
        print "maize stock name = " . $cassava_stock->name . "\n";
        ...
        my $genotype = $schema->resultset("Genetic::Genotype")->find_or_create(
            {
                ...
                description => "maize SNP genotypes for stock $ (name = " . $cassava_stock->name . ", id = " . $cassava_stock->stock_id . ")",
