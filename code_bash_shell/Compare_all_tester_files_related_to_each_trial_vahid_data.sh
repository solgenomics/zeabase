#~/code/code_bash_shell/Compare_all_tester_files_related_to_each_trial_vahid_data.sh 153_trials_from_380_exp_files.txt
...
#grep -c "$f" 380_tester_file.txt
#grep -c "$f" all_380_files4exp_2.txt
#grep "$f" 380_tester_file.txt
...
ReExfile=(`grep "$f" 380_tester_file.txt`)
