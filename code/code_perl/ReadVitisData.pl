...
#print "number of rows in feature table: ",$schema->resultset('Sequence::Feature')->count,"\n";
...
my $coderef = sub {
	...
	print "This is number I want to see: $num \n";
	  #  print "@rows  \n";



	my $entry=$spreadsheet->value_at($num, "ENTRY");
...
#	$uniquename .= "_" .$season;
        ...
        print "plot_stock_uniquename:" . $plot_stock->uniquename. "\n";


        print STDERR "Test**Loading plot stock " . $plot_stock->uniquename . " (parent = " . $parent_stock->uniquename . ")\n\n";
	...
	my $owner_insert = "INSERT INTO phenome.stock_owner (sp_person_id, stock_id) VALUES (?,?)";
	   ...
	   # print "$value ";
	    ...
	    #print "full_accession, $full_accession \n";
	    #print "full_unit,$full_unit \n";
...
####################
	   ...
	   # if ($value !~ /^\d/) {
	    ...
	    print "Where is phenotype:"  .$phenotype. " \n";
