#~/code/code_bash_shell/Find_exps_files_related_to_each_trial_vahid_data.sh 153_trials_from_380_exp_files.txt
...
grep -c "$f" all_380_files4exp.txt
#grep -c "$f" all_380_files4exp_2.txt
grep "$f" all_380_files4exp.txt
...
ReExfile=(`grep "$f" all_380_files4exp.txt`)
